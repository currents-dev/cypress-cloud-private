...
(async function runValidation() {
    try {
        ...
        const modifiedCurrentApiFile = fs.readFileSync('data-references/modified-cypress-13/currents-api-output-reference.json', 'utf8');
        const modifiedCypressCloudFile = fs.readFileSync('data-references/modified-cypress-13/cypress-cloud-output-reference.json', 'utf8');
