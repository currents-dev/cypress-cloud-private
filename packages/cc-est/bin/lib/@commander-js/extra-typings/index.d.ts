...
export class Command<Args extends any[] = [], Opts extends OptionValues = {}> {
  ...
  argument<S extends string, T>(
    ...
    description: string,
    fn: (value: string, previous: T) => T
  ): Command<[...Args, InferArgument<S, undefined, T>]>;
  argument<S extends string, T>(
    flags: S,
    description: string,
    fn: (value: string, previous: T) => T,
    defaultValue: T
  ): Command<[...Args, InferArgument<S, T, T>]>;
  argument<S extends string>(
    usage: S,
    description?: string
  ): Command<[...Args, InferArgument<S, undefined>]>;
  argument<S extends string, DefaultT>(
    usage: S,
    description: string,
    defaultValue: DefaultT
  ): Command<[...Args, InferArgument<S, DefaultT>]>;
  ...
  arguments<Names extends string>(
    args: Names
  ): Command<[...Args, ...InferArguments<Names>]>;
